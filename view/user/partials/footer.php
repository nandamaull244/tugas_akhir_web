    ...
    <div class="container">
        <div class="row gy-4">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="footer-links">
                    <li><a href="brand/samsung.php">Samsung</a></li>
                    <li><a href="brand/iphone.php">Apple</a></li>
                </ul>
            </div>

            <div class="col-lg-3 col-md-6">
                <h6 class="footer-title">Kontak Kami</h6>
                <p><i class="bi bi-geo-alt-fill me-2"></i>Cianjur, Indonesia</p>
                <p><i class="bi bi-telephone-fill me-2"></i>0812-3456-7890</p>
            </div>
        ...
        <div class="text-center small">
            © <?= date('Y') ?> Gridova ID. All rights reserved.
        </div>
    </div>
</footer>
